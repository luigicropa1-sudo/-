...
TEXT = [
    ...
    ("<strong>Le proposte del giorno</strong><span>Il menù cambia ogni giorno: chiedi in sala o chiamaci per sapere cosa c'è oggi</span>",
     "<strong>Today's dishes</strong><span>The menu changes every day: ask our staff or call us to find out what's on today</span>"),
...
FAQ = [
    ...
    ("C'è un menù per il pranzo?", "Do you have a lunch menu?",
     "Sì, dal martedì al venerdì puoi scegliere tra il menù pizza a 10 € (pizza classica, bevanda e caffè) e il menù fisso a 12 €.",
     "Yes, from Tuesday to Friday you can choose between the €10 pizza menu (classic pizza, drink and coffee) and the €12 set menu."),
